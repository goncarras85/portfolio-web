...
const socials = [
  {
    label: 'GitHub',
    href: 'https://github.com/goncarras85',
    Icon: Github,
  },
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/gonzalocarrascosanchez',
    Icon: LinkedIn,
  },
  {
    label: 'Email',
    href: 'mailto:goncarrass@gmail.com',
    Icon: Mail,
  },
]
    ...
    <footer className="border-t border-slate-800/80 px-6 py-10">
      <div className="mx-auto flex max-w-5xl flex-row items-center justify-between">
        <p className="text-left font-mono text-sm text-slate-500">
          <span className="text-emerald-500">$</span> Diseñado por Gonzalo
          Carrasco Sánchez
        </p>

        <nav className="flex items-center gap-5" aria-label="Enlaces sociales">
